...
\title{jointCalib: A Joint Calibration of Totals and Quantiles}
...
Some packages on interactive graphics include \CRANpkg{plotly} \citep{plotly}
that interfaces with Javascript for web-based interactive graphics,
\CRANpkg{crosstalk} \citep{crosstalk} that specializes cross-linking elements
across individual graphics. The recent R Journal paper
\CRANpkg{tsibbletalk} \citep{RJ-2021-050} provides a good example of
...
Marcin Szymkowiak\\
Poznań University of Economics and Business Statistical Office in Poznań\\%
Department of Statistics, Al. Niepodległości 10, 61-875 Poznań, Poland\\ Wojska Polskiego 27/29, 60-624 Poznań Poland\\
%
\url{https://www.britannica.com/animal/bilby}\\%
\textit{ORCiD: \href{https://orcid.org/0000-0003-3432-4364}{0000-0003-3432-4364}}\\%
\href{mailto:marcin.szymkowiak@ue.poznan.pl}{\nolinkurl{marcin.szymkowiak@ue.poznan.pl}}%
}
